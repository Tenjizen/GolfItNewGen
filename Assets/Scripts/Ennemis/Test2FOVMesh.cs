...
public class Test2FOVMesh : MonoBehaviour
{
    public Test2Fov fov;
    Mesh mesh;
    RaycastHit2D hit;
    ...
    void Start()
    {
        ...
        fov = GetComponentInParent<Test2Fov>();
    }
    ...
    private void MakeMesh()
    {
        ...
        for (int i = 0; i < stepCount; i++)
        {
            ...
            hit = Physics2D.Raycast(fov.transform.position, dir, fov.viewRad, fov.obstacleMask);

            if (hit.collider == null)
            {
                viewVertex.Add(transform.position + dir.normalized * fov.viewRad);
            }
            else
            {
